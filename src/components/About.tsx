        ...
        <div className="max-w-md">
          ...
          <div className="hidden lg:block mt-6">
            ...
            <div className="mt-2 flex flex-col gap-3 text-xs font-medium uppercase tracking-widest leading-relaxed text-foreground-secondary">
              <a href="https://partiful.com/e/At1KGtYFwUrumOX2ZU6K?c=c9MuK8zo" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground transition-colors">
